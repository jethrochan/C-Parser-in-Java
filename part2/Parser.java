...
public class Parser {
  ...
  //  int varcount=0;
    ...
    private void declarations() {
		...
		//if it isn't, add it + line number of declaration
		//if it is, add line number of redeclaration
		//might need to give an error message if declared 
		//in same line i.e., variable is not being "hidden"
        }
        mustbe(TK.RAV);
    }
